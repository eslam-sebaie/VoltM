...
//class TabbarVC: UIViewController {
    ...
    @IBDesignable class TabbarVC: UITabBar {
        ...
        private lazy var background: CAShapeLayer = {
            if L10n.lang.localized == Language.arabic {
                self.items![0].image = Asset.homeAr.image
                self.items![1].image = Asset.storeAR.image
                self.items![2].image = Asset.serviceAr.image
                self.items![3].image = Asset.cartAr.image
                self.items![4].image = Asset.favAr.image
                self.items![0].selectedImage = Asset.selectedHomeAr.image
                self.items![1].selectedImage = Asset.selectedStoreAr.image
                self.items![2].selectedImage = Asset.selectedServiceAr.image
                self.items![3].selectedImage = Asset.selectedCartAr.image
                self.items![4].selectedImage = Asset.selectedFavAr.image
            }
